#!/usr/bin/env python3
"""NCP v5 seed 2 — cross-sectional attention — OVH H100 cuda:0."""
import os
...
WORK = "/workspace"
WEIGHTS_PATH = f"{WORK}/ncp_v5_seed2.pt"
CKPT_TXT     = f"{WORK}/checkpoint_v5_seed2.txt"
os.makedirs(f"{WORK}/ckpts_v5_seed2", exist_ok=True)
...
def _ckpt(model, epoch):
    ...
    torch.save(model.state_dict(), f"{WORK}/ckpts_v5_seed2/epoch_{epoch:03d}.pt")
